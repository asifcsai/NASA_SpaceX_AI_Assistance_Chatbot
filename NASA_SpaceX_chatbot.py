...
# Configuration
os.environ['GROQ_API_KEY'] = 'replace by your api'
...
def main():
    ...
    # Custom CSS for better chat colors and auto-scroll
    st.markdown("""
    <style>
    ...
    /* Ensure chat input is at bottom */
    ...
    // Run scroll function after page loads
    ...
    if user_input:
        ...
        setTimeout(function() {
            ...
            // Also try scrolling the entire window
